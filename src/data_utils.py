...
def scale_data(train_data, val_data=None, scaler_type="robust"):
    ...
    if scaler_type == "minmax":
        ...
        raise ValueError(
            "Invalid scaler type. Please choose 'minmax' or 'standard' or 'robust'."
        )
...
def balance_data_transformation(
    X_train,
    y_train,
    balance_type="smote",
    ...
    if balance_type == "under":
        ...
        raise ValueError(
            "Invalid balance type. Please choose 'under_sampling', 'over_sampling', 'smote', 'SMOTEENN', or 'SMOTETomek'."
        )
